		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping App",
									"targetURL": "#comibsplshppingcart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplshppingcart-display": {
								"semanticObject": "comibsplshppingcart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.shppingcart",
									"url": sap.ui.require.toUrl("com/ibspl/shppingcart")
								}
							}
						}
					}
